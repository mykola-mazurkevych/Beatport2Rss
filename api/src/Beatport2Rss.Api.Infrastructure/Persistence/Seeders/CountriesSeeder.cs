...
namespace Beatport2Rss.Api.Infrastructure.Persistence.Seeders;

internal static class CountriesSeeder
{
    private const string ResourceName = "Beatport2Rss.Api.Infrastructure.Persistence.Seeders.Data.countries_csv.md.md";
