...
namespace Beatport2Rss.Api.Infrastructure.Persistence.Extensions;

internal static class MigrationBuilderExtensions
{
    private const string NamespacePrefix = "Beatport2Rss.Api.Infrastructure.Persistence.Views";
