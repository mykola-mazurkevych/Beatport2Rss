...
internal static class ServiceCollectionExtensionUserValidationBehaviorsSourceOutput
{
        ...
        IReadOnlyList<MediatorMessageInfo> mediatorMessageInfos)
    {
        ...
        builder.AppendLine("{");
        builder.AppendLine("    private static partial IServiceCollection AddUserValidationBehaviors(this IServiceCollection services) =>");
        ...
        foreach (var info in mediatorMessageInfos.OrderBy(i => i.Name))
        {
            ...
            builder.Append(", ");
            builder.Append($"{info.Name}UserValidationBehavior");
            builder.Append(">()");
        }
        ...
        context.AddSource("ServiceCollectionExtensions.UserValidationBehaviors.g.cs", builder.ToString());
    }
}