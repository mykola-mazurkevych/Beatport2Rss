...
internal static class ServiceCollectionExtensionTagValidationBehaviorsSourceOutput
{
        ...
        IReadOnlyList<MediatorMessageInfo> mediatorMessageInfos)
    {
        ...
        builder.AppendLine("{");
        builder.AppendLine("    private static partial IServiceCollection AddTagValidationBehaviors(this IServiceCollection services) =>");
        ...
        foreach (var info in mediatorMessageInfos.OrderBy(i => i.Name))
        {
            ...
            builder.Append(", ");
            builder.Append($"{info.Name}TagValidationBehavior");
            builder.Append(">()");
        }
        ...
        context.AddSource("ServiceCollectionExtensions.TagValidationBehaviors.g.cs", builder.ToString());
    }
}