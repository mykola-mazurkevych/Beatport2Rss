...
internal static class ServiceCollectionExtensionSubscriptionValidationBehaviorsSourceOutput
{
        ...
        IReadOnlyList<MediatorMessageInfo> mediatorMessageInfos)
    {
        ...
        builder.AppendLine("{");
        builder.AppendLine("    private static partial IServiceCollection AddSubscriptionValidationBehaviors(this IServiceCollection services) =>");
        ...
        foreach (var info in mediatorMessageInfos.OrderBy(i => i.Name))
        {
            ...
            builder.Append(", ");
            builder.Append($"{info.Name}SubscriptionValidationBehavior");
            builder.Append(">()");
        }
        ...
        context.AddSource("ServiceCollectionExtensions.SubscriptionValidationBehaviors.g.cs", builder.ToString());
    }
}